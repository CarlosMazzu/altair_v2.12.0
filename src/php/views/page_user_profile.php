        ...
        <div id="page_content_inner">
            <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
                <div class="uk-width-large-7-10">
                    <div class="md-card">
                        <div class="user_heading user_heading_bg" style="background-image: url('<?php echo $img_path?>/gallery/Image10.jpg')">
                            <div class="bg_overlay">
                                ...
                                <div class="user_heading_avatar">
                                    <div class="thumbnail">
                                        <img src="<?php echo $img_path?>/avatars/avatar_03.png" alt="user avatar"/>
                                    </div>
                                </div>
                                <div class="user_heading_content">
                                    <h2 class="heading_b uk-margin-bottom"><span class="uk-text-truncate"><?php echo $faker->firstNameMale;?> <?php echo $faker->lastName;?></span><span class="sub-heading">Land acquisition specialist</span></h2>
                                    <ul class="user_stats">
                                        <li>
